...
router.route('/add').post((req, res) => {         ///add method & post request
  ...
  const newUser = new Issue({                      // write new issue to table and then save it   
    username,
    descr,
    image1,
    image2,
